...
urlpatterns = [
    ...
    path('post/<int:post_id>/add_comment/<int:comment_id>', views.CommentView.as_view(),
         name='add_comment_reply'),
    path('post/<int:post_id>/add_comment', views.CommentView.as_view(), name='add_comment'),
